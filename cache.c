...
#define SLAVE_OUTPUT_IO_1    12
#define SLAVE_OUTPUT_PIN_SEL_1  (1ULL<<SLAVE_OUTPUT_IO_1)

#define SLAVE_OUTPUT_IO_2    14
#define SLAVE_OUTPUT_PIN_SEL_2  (1ULL<<SLAVE_OUTPUT_IO_2)
...
static void root_task(void *arg)
{
    ...
    gpio_config_t slave_io_conf_output_1;
    slave_io_conf_output_1.intr_type = GPIO_PIN_INTR_DISABLE;
    slave_io_conf_output_1.mode = GPIO_MODE_OUTPUT;
    slave_io_conf_output_1.pin_bit_mask = SLAVE_OUTPUT_IO_1;
    slave_io_conf_output_1.pull_up_en = 0;
    slave_io_conf_output_1.pull_down_en = 0;
    gpio_config(&slave_io_conf_output_1);

    gpio_config_t slave_io_conf_output_2;
    slave_io_conf_output_2.intr_type = GPIO_PIN_INTR_DISABLE;
    slave_io_conf_output_2.mode = GPIO_MODE_OUTPUT;
    slave_io_conf_output_2.pin_bit_mask = SLAVE_OUTPUT_IO_2;
    slave_io_conf_output_2.pull_up_en = 0;
    slave_io_conf_output_2.pull_down_en = 0;
    gpio_config(&slave_io_conf_output_2);
    ...
    for (int i = 0;; ++i) {
        ...
        for (int i = 0; i < wifi_sta_list.num; i++) {
            ...
            char currentMAC[18];
            sprintf(currentMAC, MACSTR, MAC2STR(wifi_sta_list.sta[i].mac));

            (strcmp(currentMAC, "a4:cf:12:75:01:f4") == 0) ? gpio_set_level(SLAVE_OUTPUT_IO_1, 1) : gpio_set_level(SLAVE_OUTPUT_IO_1, 0);
            (strcmp(currentMAC, "24:6f:28:ab:1d:d4") == 0) ? gpio_set_level(SLAVE_OUTPUT_IO_2, 1) : gpio_set_level(SLAVE_OUTPUT_IO_2, 0);
        }
    }
